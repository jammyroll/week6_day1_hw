...
const favouriteFilms = ["LOTRS1",'LOTRS2','LOTRS3']
favouriteFilms.unshift('Nickleback')
favouriteFilms.pop()
...
programmingLanguages.splice([programmingLanguages.indexOf('Visual Basic')],1)
...
const myString = 'Work hard and be nice'
const arrFromStr =myString.split(' ')
console.log(arrFromStr.length);


for (const str of arrFromStr) {
